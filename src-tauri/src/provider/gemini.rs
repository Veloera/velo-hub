use crate::converter::{FormatConverter, GeminiResponse};
...
impl ProviderAdapter for GeminiAdapter {
    async fn send_request(
        ...
        let gemini_request = FormatConverter::openai_to_gemini(request)?;
        ...
        FormatConverter::gemini_to_openai(gemini_response, &request.model)
    }
